...
//there going to be moment where username password is in javascript
//can move from token auth to cookie auth but then might be more challenging
function App() {
  //proiblem with storing user details in localStorage is if code gets access to it through
  //something installed on your computer then can ajax request with it
  //if got access to details in localStorrage then possible to log into app and might
  //be reusing same credentials in different sites
